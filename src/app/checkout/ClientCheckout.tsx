                      ...
                      <div className="mt-6 p-6 bg-white border border-gray-200 rounded-[12px] shadow-sm">
                        ...
                        <div className="space-y-4">
                          <div className="flex justify-between items-center py-3 border-b border-gray-100">
                            ...
                            <span className="text-[14px] font-bold text-[#1a1a1a]">Moniepoint Microfinance Bank</span>
                          </div>
                          <div className="flex justify-between items-center py-3 border-b border-gray-100">
                            <span className="text-[13px] text-gray-500">Account Number</span>
                            <div className="flex items-center gap-3">
                              <span className="text-[18px] font-manrope font-extrabold text-[#008b45] tracking-widest">9133485636</span>
                              <button type="button" onClick={() => handleCopy('9133485636')} className="text-gray-400 hover:text-[#008b45] transition-colors">
                          ...
                          <div className="flex justify-between items-center py-3">
                            ...
                            <span className="text-[14px] font-bold text-[#1a1a1a]">GETLANDS</span>
                          </div>
                        </div>
