...
import { createOpportunity } from '@/app/actions/admin';

export default function CreateOpportunityPage() {
  const [category, setCategory] = useState<'land' | 'farm' | 'land_banking'>('land');
  ...
  return (
    <div className="max-w-[800px] mx-auto space-y-[40px]">
      <div className="flex items-center gap-[15px]">
        ...
        <div>
          <h1 className="font-manrope text-[24px] lg:text-[32px] tracking-[-0.03em] font-bold text-ink leading-none mb-[5px]">Create Opportunity</h1>
          <p className="text-[13px] text-[#68736d]">Configure a new asset for the marketplace.</p>
        </div>
      </div>

      <form className="space-y-[30px]" action={createOpportunity}>
        ...
        <div className="bg-white rounded-[24px] p-[30px] border border-black/5 shadow-sm space-y-[20px] animate-fade-in">
          <h2 className="font-manrope text-[18px] font-bold mb-[20px]">2. Basic Details</h2>
              ...
              <input type="file" accept="image/*" name="coverImage" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" required />
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px]">
            <div className="md:col-span-2">
              <label className="block text-[13px] font-bold text-ink mb-[8px]">Title <span className="text-[#e53935]">*</span></label>
              <input type="text" name="title" placeholder="e.g. 60x120 Plot in Abeokuta" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" required />
            </div>
            
            <div>
              <label className="block text-[13px] font-bold text-ink mb-[8px]">Location / City <span className="text-[#e53935]">*</span></label>
              <input type="text" name="location" placeholder="e.g. Abeokuta" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" required />
            </div>
            
            <div>
              <label className="block text-[13px] font-bold text-ink mb-[8px]">State <span className="text-[#e53935]">*</span></label>
              <select name="state" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" required>
            ...
            <div>
              ...
              <select name="status" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" required>
            ...
            {category === 'land' && (
              <>
                <div>
                  ...
                  <input type="number" name="price" placeholder="500000" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" required />
                </div>
                <div>
                  <label className="block text-[13px] font-bold text-ink mb-[8px]">Size</label>
                  <input type="text" name="landSize" placeholder="e.g. 60 x 120 ft" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" />
                </div>
                <div>
                  <label className="block text-[13px] font-bold text-ink mb-[8px]">Title Document</label>
                  <input type="text" name="documentationStatus" placeholder="e.g. C of O, Registered Survey" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" />
                </div>
              </>
            )}
            ...
            {category === 'farm' && (
              <>
                <div>
                  ...
                  <input type="number" name="slotPrice" placeholder="100000" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" required />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="number" name="duration" placeholder="6" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" required />
                </div>
              </>
            )}
            ...
            {category === 'land_banking' && (
              <>
                <div>
                  ...
                  <input type="number" name="acquisitionPrice" placeholder="1000000" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" required />
                </div>
                <div>
                  <label className="block text-[13px] font-bold text-ink mb-[8px]">Holding Period (Months) <span className="text-[#e53935]">*</span></label>
                  <input type="number" name="duration" placeholder="12" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" required />
                </div>
                <div>
                  <label className="block text-[13px] font-bold text-ink mb-[8px]">Stated Exit Value (₦) <span className="text-[#e53935]">*</span></label>
                  <input type="number" name="statedExitValue" placeholder="1400000" className="w-full h-[50px] bg-[#f7f9f7] rounded-[12px] px-[15px] outline-none focus:border-[#008b45] border border-transparent transition-colors" required />
                </div>
              </>
            )}
          </div>
